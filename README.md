...
| HIDE      | The HIDE (Human-aware Image Deblurring) dataset consists of 8,422 blurred images paired with their corresponding sharp images, focusing on motion deblurring with an emphasis on human subjects, making it ideal for human-centric deblurring tasks. | -                                                                                             |
